...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-surface grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-leaf-700 text-white relative overflow-hidden">
        <Logo className="[&_span]:text-white [&_div:first-child]:bg-white [&_svg]:text-leaf-700" />
        <div className="relative z-10">
          <h2 className="text-4xl font-semibold leading-tight tracking-tight max-w-md">Your residency, thoughtfully managed.</h2>
          <p className="mt-4 text-leaf-100 max-w-md">Sign in to view your allocation, chat with roommates, and stay ahead of clearance deadlines.</p>
        </div>
        <div className="absolute -right-24 -bottom-24 size-96 rounded-full bg-leaf-600/40 blur-3xl" />
        <p className="text-xs text-leaf-100/70 relative">© 2026 CampusStay Housing Systems</p>
      </div>
